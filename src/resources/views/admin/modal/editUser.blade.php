                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <select type="text" class="form-control" id="tipe" name="tipe">
                                ...
                                <option value="Guest" {{$data->tipe == 'Guest' ? 'selected' : ''}}>Guest</option>
                                <option value="Pemula" {{$data->tipe == 'Pemula' ? 'selected' : ''}}>Pemula</option>
                                <option value="Menengah" {{$data->tipe == 'Menengah' ? 'selected' : ''}}>Menengah</option>
                                <option value="Calon Atlet" {{$data->tipe == 'Calon Atlet' ? 'selected' : ''}}>Calon Atlet</option>
                            </select>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <input type="date" value="{{$data->payment_date}}" class="form-control" id="payment_date" name="payment_date">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="expired_date" class="col-sm-5 col-form-label">Expired Date</label>
                        <div class="col-sm-7">
                            <input type="date" value="{{$data->expired_date}}" class="form-control" id="expired_date" name="expired_date">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <div class="foto-container">
                                <div class="preview-container">
                                    ...
                                    <input type="file" class="form-control d-none" accept=".png, .jpg, .jpeg" id="inputFoto" name="bukti" onchange="previewImg(this)" style="display: none;">
                                </div>
                            </div>
                        </div>
                    </div>                    
