...
<div class="modal fade" id="adminTambah" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <form action="{{ route('addAdmin') }}" enctype="multipart/form-data" method="POST">
            @csrf
